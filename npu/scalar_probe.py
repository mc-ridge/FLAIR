...
# gru_encoder.py
#
# IRON driver for the fused FLAIR encoder kernel (npu/kernels/scalar_probe.cc):
...
_KERNEL_SRC = _KERNELS_DIR / "scalar_probe.cc"
...
def _make_encoder_kernel(arg_types, compile_flags):
    ...
    LUT kernels rely on, plus the kernels dir (so scalar_probe.cc can
