#
# gru_encoder_noop_4core.py
#
# 4-core NOOP encoder (DIAGNOSTIC: echoes x, touches params) in one NPU column. Same kernel
# (gru_encoder_noop_bf16) as the single-core gru_encoder.py, but replicated across
